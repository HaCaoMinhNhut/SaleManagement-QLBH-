...
namespace GUI
{
    public partial class frmProduct : Form
    {
      ...
      static  DataTable dt = new DataTable();
        ...
        public frmProduct(object sender, EventArgs e):this()
        {
        ...
        private void frmProduct_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (txtId.Text == "")
                {
                    ma = ma + 1;
                    if (ma > 9 && ma <= 99)
                        txtId.Text = "SP0" + ma.ToString();
                    if (ma <= 9)
                    {
                        txtId.Text = "SP00" + ma.ToString();
                    }
                    if (ma > 99)
                    {
                        txtId.Text = "SP" + ma.ToString();
                    }
                }
            }
            else
         ...
         void idthem(int ma)
        {
            ma = Convert.ToInt32(dt.Rows[dt.Rows.Count - 1]["MASP"].ToString().Substring(2, 3));
            ...
            { 
                for (int i = 1; i < ma; i++)
                {
                    ...
                    {
                        int bien = Convert.ToInt32(dt.Rows[j]["MASP"].ToString().Substring(2, 3));
                        if (i != bien)
                        {
                            cout = 1;
                        }
                    ...
                    {
                        if (i > 9 && i <= 99)
                            txtId.Text= "SP0" + i.ToString();
                        if (i <= 9)
                        {
                            txtId.Text= "SP00" + i.ToString();
                        }
                        if (i > 99)
                        {
                            txtId.Text= "SP" + i.ToString();
                        }
                        break;
                    }
                }
        ...
        private void gvProduct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (gvProduct.Rows.Count > 0)
            {
                ...
                //if ((byte[])gvProduct.CurrentRow.Cells[5].Value == null)
                //{
                //    MemoryStream memoryStream = new MemoryStream("NULL");
                //}
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (busProduct.DeleteProduct(txtId.Text))
                {
                    gvProduct.DataSource = busProduct.ListOfProducts();
